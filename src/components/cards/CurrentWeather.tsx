  ...
  return (
    ...
    >
      <h2 className="text-6xl font-semibold text-center">
        {ApiUtils.formatAndRoundToHalf(data?.current.temperature_2m as number)}
        °C
      </h2>
      <WeatherIcon
      ...
      <h3 className="capitalize text-xl">
        {" "}
        {WeatherNameMap[data?.current.weather_code || 0]}
      </h3>
      ...
      <div className="flex justify-between w-full">
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <p>
            {ApiUtils.formatAndRoundToHalf(data?.current.wind_speed_10m || 0)}
            km/h
          </p>
        </div>
      </div>
